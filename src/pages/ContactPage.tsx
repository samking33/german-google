  ...
  return (
    <div ref={ref} className="relative h-[60vh] overflow-hidden bg-brand-dark flex items-end pb-16">
      <motion.div style={{ y }} className="absolute inset-0">
        <img src={IMAGES.kontaktHero} alt="Kontakt" className="w-full h-full object-cover opacity-40" />
      ...
      <motion.div style={{ opacity }} className="relative z-10 max-w-[1440px] mx-auto px-8 w-full">
        ...
        >
          ...
          <span className="text-[10px] uppercase tracking-[0.35em] text-brand-teal font-bold">Sprechen wir</span>
        </motion.div>
        <div className="overflow-hidden">
          ...
          >
            KONTAKT.<br />
            <span className="italic font-normal text-white/30">ANFRAGE.</span>
          </motion.h1>
        </div>
      </motion.div>
    </div>
